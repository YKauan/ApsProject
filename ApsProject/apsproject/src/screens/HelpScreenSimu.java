...
public class HelpScreenSimu extends JPanel {
    ...
    private void setImgBackground(int imageIndex) {
        switch (imageIndex) {
            case 0:
                ...
                break;
            case 1:
                backgroundImage = images.getHelpSimu1();
                break;
            case 2:
                backgroundImage = images.getHelpSimu2();
                break;
            case 3:
                backgroundImage = images.getHelpSimu3();
                break;
            default:
                break;
        }
    ...
    private void labelsS1(){
        ...
        help1Txt1 = new JLabel(languageManager.getString("helpS1Txt1"));
        help1Txt2 = new JLabel(languageManager.getString("helpS1Txt2"));
        help1Txt3 = new JLabel(languageManager.getString("helpS1Txt3"));

        help1Txt1.setForeground(Color.WHITE);
        help1Txt2.setForeground(Color.WHITE);
        help1Txt3.setForeground(Color.WHITE);

        add(help1Txt1);
        add(help1Txt2);
        add(help1Txt3);

        layout.putConstraint(SpringLayout.WEST, help1Txt1, 465, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, help1Txt1, 100, SpringLayout.NORTH, this);
        layout.putConstraint(SpringLayout.WEST, help1Txt2, 465, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, help1Txt2, 120, SpringLayout.NORTH, this);
        layout.putConstraint(SpringLayout.WEST, help1Txt3, 465, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, help1Txt3, 311, SpringLayout.NORTH, this);
    ...
    private void labelsS2(){
        ...
        //=> Adicionando os novos textos a tela
        help2Txt1 = new JLabel(languageManager.getString("helpS2Txt1"));
        help2Txt2 = new JLabel(languageManager.getString("helpS2Txt2"));
        help2Txt3 = new JLabel(languageManager.getString("helpS2Txt3"));
        ...
        layout.putConstraint(SpringLayout.WEST, help2Txt1, 550, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, help2Txt1, 150, SpringLayout.NORTH, this);

        layout.putConstraint(SpringLayout.WEST, help2Txt2, 550, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, help2Txt2, 227, SpringLayout.NORTH, this);

        layout.putConstraint(SpringLayout.WEST, help2Txt3, 550, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, help2Txt3, 300, SpringLayout.NORTH, this);
    ...
    private void labelsS3(){
        ...
        //=> Adicionando os novos textos a tela
        help3Txt1 = new JLabel(languageManager.getString("helpS3Txt1"));
        help3Txt2 = new JLabel(languageManager.getString("helpS3Txt2"));
        help3Txt3 = new JLabel(languageManager.getString("helpS3Txt3"));
        help3Txt4 = new JLabel(languageManager.getString("helpS3Txt4"));
        ...
        layout.putConstraint(SpringLayout.WEST, help3Txt1, 565, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, help3Txt1,  76, SpringLayout.NORTH, this);

        layout.putConstraint(SpringLayout.WEST, help3Txt2, 565, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, help3Txt2, 154, SpringLayout.NORTH, this);

        layout.putConstraint(SpringLayout.WEST, help3Txt3, 565, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, help3Txt3, 278, SpringLayout.NORTH, this);

        layout.putConstraint(SpringLayout.WEST, help3Txt4, 565, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, help3Txt4, 360, SpringLayout.NORTH, this);
